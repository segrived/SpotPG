...
namespace SpotPG.Services
{
    public class SceneReleaseNameParserService : ISceneReleaseNameParserService
    {
        ...
        private static string ProcessArtistsPart(string artistsPart)
        {
            string updatesStr = artistsPart.Replace("_", " ");
    ...
    public record ReleaseInfo(string Artists, string Title, int Year);
}